...
Program::Program() : camera(glm::vec3(0.0f,2.0f,3.0f), 0, 0, 0)
{
...
void Program::run()
{
	Mesh susy = loadModel("./juno_engine/res/volleyball.obj");
	Texture texture_one("./juno_engine/res/noise_imgtexture.png", TX_DIFFUSE, true);
	...
	// Terrain terrain(0, 0, texture_one);
