...
static unsigned int loadTexture(const std::string& filepath, GLenum format, juno::TextureType tx_type)
{
...
//     /* custom obj importer */
//     static juno::Mesh loadOBJFileFile(std::string& filepath)
//     {
//         std::string line;                            /* per line .obj info */
...
//         juno::Mesh mesh(vertices_data, textures_data, normals_data, indices, ptr_furthest);
...
//     static juno::Mesh loadModel(std::string& filepath)
//     {
//         if(filepath.find(".obj") != std::string::npos)
//         {
