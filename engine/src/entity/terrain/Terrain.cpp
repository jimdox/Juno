...
// Terrain::Terrain(float x_coord, float z_coord, Texture& texture) : texture(texture)
// {
...
//         // auto [id, numIndices] = loadToVAO(vertices, texCoordinates, normals, indices);
//         // this->mesh = Mesh(id, numIndices, vertices.size());
// }
