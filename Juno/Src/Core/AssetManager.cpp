...
CubeMap& AssetManager::LoadCubeMap(const std::string& filepath, TextureType texType)
{
...
unsigned int AssetManager::LoadTextureFile(const std::string& filepath, GLenum format, TextureType texType)
{
	...
	else
	{
	    ...
	    return LoadTextureFile("./Resources/Textures/planet.png", format, texType);
	}
